...
export default function SubmitIssue() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			setSuccess(
				"Issue submitted successfully! You earned 1 credit. Pending review for additional credits."
			);
			setForm({
				title: "",
				description: "",
			...
			setSuccess("");
			const errorMessage =
				err.response?.data?.error || err.message || "Error submitting issue";
			alert(errorMessage);
		}
	};
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-8 px-4 flex items-center justify-center">
			<div className="w-full max-w-2xl">
				<h2 className="text-3xl font-bold mb-6 text-blue-900 tracking-tight text-center">
					Report an Issue / News
				</h2>
				{success && (
					<div className="bg-green-100 text-green-800 p-3 rounded mb-4 text-center font-semibold shadow">
						{success}
					</div>
				)}
				<form
				...
				<div className="mt-6 text-sm text-gray-500">
					<b>Note:</b> All reports are reviewed by moderators. Earn credits for
